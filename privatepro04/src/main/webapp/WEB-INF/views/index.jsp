    ...
    <div class="header">
        <div class="home-menu pure-menu pure-menu-horizontal pure-menu-fixed">
            ...
            <ul class="pure-menu-list">
                ...
                <li class="pure-menu-item"><a href="${path1 }/user/loginForm" class="pure-menu-link">Login</a></li>
                <li class="pure-menu-item"><a href="${path1 }/user/agree" class="pure-menu-link">Sign Up</a></li>
            </ul>
        </div>
    </div>
